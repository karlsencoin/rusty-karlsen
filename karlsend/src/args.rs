    ...
    let cmd = Command::new("karlsend")
        ...
        .arg(
            Arg::new("rpclisten")
                ...
                .help("Interface:port to listen for gRPC connections (default port: 42110, testnet: 42210)."),
        )
        .arg(
        ...
        .arg(
            Arg::new("listen")
                ...
                .require_equals(true)
                .value_parser(clap::value_parser!(ContextualNetAddress))
                .help("Add an interface:port to listen for connections (default all interfaces port: 42111, testnet: 42211)."),
        )
        .arg(
            Arg::new("outpeers")
                .long("outpeers")
