...
use karlsen_consensus_core::{network::NetworkId, Hash};
...
from!(item: &karlsen_rpc_core::SubmitBlockReport, RejectReason, {
    match item {
        karlsen_rpc_core::SubmitBlockReport::Success => RejectReason::None,
        karlsen_rpc_core::SubmitBlockReport::Reject(karlsen_rpc_core::SubmitBlockRejectReason::BlockInvalid) => RejectReason::BlockInvalid,
        karlsen_rpc_core::SubmitBlockReport::Reject(karlsen_rpc_core::SubmitBlockRejectReason::IsInIBD) => RejectReason::IsInIbd,
        ...
        karlsen_rpc_core::SubmitBlockReport::Reject(karlsen_rpc_core::SubmitBlockRejectReason::RouteIsFull) => RejectReason::None,
    }
});

from!(item: &karlsen_rpc_core::SubmitBlockRequest, protowire::SubmitBlockRequestMessage, {
...
// message is provided.
from!(item: RpcResult<&karlsen_rpc_core::SubmitBlockResponse>, protowire::SubmitBlockResponseMessage, {
    let error: Option<protowire::RpcError> = match item.report {
        karlsen_rpc_core::SubmitBlockReport::Success => None,
        karlsen_rpc_core::SubmitBlockReport::Reject(reason) => Some(RpcError::SubmitBlockError(reason).into())
    };
    Self { reject_reason: RejectReason::from(&item.report) as i32, error }
});

from!(item: &karlsen_rpc_core::GetBlockTemplateRequest, protowire::GetBlockTemplateRequestMessage, {
    Self {
...
from!(item: RpcResult<&karlsen_rpc_core::GetBlockTemplateResponse>, protowire::GetBlockTemplateResponseMessage, {
    Self { block: Some((&item.block).into()), is_synced: item.is_synced, error: None }
});

from!(item: &karlsen_rpc_core::GetBlockRequest, protowire::GetBlockRequestMessage, {
    Self { hash: item.hash.to_string(), include_transactions: item.include_transactions }
});
from!(item: RpcResult<&karlsen_rpc_core::GetBlockResponse>, protowire::GetBlockResponseMessage, {
...
from!(item: &karlsen_rpc_core::GetMempoolEntryRequest, protowire::GetMempoolEntryRequestMessage, {
    Self {
...
from!(item: RpcResult<&karlsen_rpc_core::GetMempoolEntryResponse>, protowire::GetMempoolEntryResponseMessage, {
    Self { entry: Some((&item.mempool_entry).into()), error: None }
});

from!(item: &karlsen_rpc_core::GetMempoolEntriesRequest, protowire::GetMempoolEntriesRequestMessage, {
    Self { include_orphan_pool: item.include_orphan_pool, filter_transaction_pool: item.filter_transaction_pool }
});
from!(item: RpcResult<&karlsen_rpc_core::GetMempoolEntriesResponse>, protowire::GetMempoolEntriesResponseMessage, {
...
from!(item: RpcResult<&karlsen_rpc_core::SubmitTransactionResponse>, protowire::SubmitTransactionResponseMessage, {
...
from!(item: RpcResult<&karlsen_rpc_core::GetSubnetworkResponse>, protowire::GetSubnetworkResponseMessage, {
    Self { gas_limit: item.gas_limit, error: None }
});

// ~~~

from!(item: &karlsen_rpc_core::GetVirtualChainFromBlockRequest, protowire::GetVirtualChainFromBlockRequestMessage, {
...
from!(item: RpcResult<&karlsen_rpc_core::GetVirtualChainFromBlockResponse>, protowire::GetVirtualChainFromBlockResponseMessage, {
    Self {
...
from!(item: &karlsen_rpc_core::GetBlocksRequest, protowire::GetBlocksRequestMessage, {
    Self {
...
from!(item: RpcResult<&karlsen_rpc_core::GetBlocksResponse>, protowire::GetBlocksResponseMessage, {
    Self {
...
from!(item: &karlsen_rpc_core::ResolveFinalityConflictRequest, protowire::ResolveFinalityConflictRequestMessage, {
    Self { finality_block_hash: item.finality_block_hash.to_string() }
});
from!(_item: RpcResult<&karlsen_rpc_core::ResolveFinalityConflictResponse>, protowire::ResolveFinalityConflictResponseMessage, {
    Self { error: None }
});
...
from!(item: RpcResult<&karlsen_rpc_core::GetHeadersResponse>, protowire::GetHeadersResponseMessage, {
    Self { headers: item.headers.iter().map(|x| x.hash.to_string()).collect(), error: None }
});

from!(item: &karlsen_rpc_core::GetUtxosByAddressesRequest, protowire::GetUtxosByAddressesRequestMessage, {
    Self { addresses: item.addresses.iter().map(|x| x.into()).collect() }
});
from!(item: RpcResult<&karlsen_rpc_core::GetUtxosByAddressesResponse>, protowire::GetUtxosByAddressesResponseMessage, {
...
from!(item: &karlsen_rpc_core::GetBalanceByAddressRequest, protowire::GetBalanceByAddressRequestMessage, {
    Self { address: (&item.address).into() }
});
from!(item: RpcResult<&karlsen_rpc_core::GetBalanceByAddressResponse>, protowire::GetBalanceByAddressResponseMessage, {
    debug!("GRPC, Creating GetBalanceByAddress messages");
    Self { balance: item.balance, error: None }
});

from!(item: &karlsen_rpc_core::GetBalancesByAddressesRequest, protowire::GetBalancesByAddressesRequestMessage, {
    Self { addresses: item.addresses.iter().map(|x| x.into()).collect() }
});
from!(item: RpcResult<&karlsen_rpc_core::GetBalancesByAddressesResponse>, protowire::GetBalancesByAddressesResponseMessage, {
    debug!("GRPC, Creating GetUtxosByAddresses message with {} entries", item.entries.len());
    Self { entries: item.entries.iter().map(|x| x.into()).collect(), error: None }
});
...
from!(item: &karlsen_rpc_core::BanRequest, protowire::BanRequestMessage, { Self { ip: item.ip.to_string() } });
from!(_item: RpcResult<&karlsen_rpc_core::BanResponse>, protowire::BanResponseMessage, { Self { error: None } });

from!(item: &karlsen_rpc_core::UnbanRequest, protowire::UnbanRequestMessage, { Self { ip: item.ip.to_string() } });
from!(_item: RpcResult<&karlsen_rpc_core::UnbanResponse>, protowire::UnbanResponseMessage, { Self { error: None } });

from!(item: &karlsen_rpc_core::EstimateNetworkHashesPerSecondRequest, protowire::EstimateNetworkHashesPerSecondRequestMessage, {
    Self { window_size: item.window_size, start_hash: item.start_hash.map_or(Default::default(), |x| x.to_string()) }
});
from!(
    item: RpcResult<&karlsen_rpc_core::EstimateNetworkHashesPerSecondResponse>,
...
from!(item: &karlsen_rpc_core::GetMempoolEntriesByAddressesRequest, protowire::GetMempoolEntriesByAddressesRequestMessage, {
    Self {
...
from!(
    item: RpcResult<&karlsen_rpc_core::GetMempoolEntriesByAddressesResponse>,
...
from!(item: &karlsen_rpc_core::GetDaaScoreTimestampEstimateRequest, protowire::GetDaaScoreTimestampEstimateRequestMessage, {
    Self {
        daa_scores: item.daa_scores.clone()
    }
});
from!(item: RpcResult<&karlsen_rpc_core::GetDaaScoreTimestampEstimateResponse>, protowire::GetDaaScoreTimestampEstimateResponseMessage, {
    Self { timestamps: item.timestamps.clone(), error: None }
});

// Fee estimate API

from!(&karlsen_rpc_core::GetFeeEstimateRequest, protowire::GetFeeEstimateRequestMessage);
from!(item: RpcResult<&karlsen_rpc_core::GetFeeEstimateResponse>, protowire::GetFeeEstimateResponseMessage, {
    Self { estimate: Some((&item.estimate).into()), error: None }
});
from!(item: &karlsen_rpc_core::GetFeeEstimateExperimentalRequest, protowire::GetFeeEstimateExperimentalRequestMessage, {
    Self {
        verbose: item.verbose
    }
});
from!(item: RpcResult<&karlsen_rpc_core::GetFeeEstimateExperimentalResponse>, protowire::GetFeeEstimateExperimentalResponseMessage, {
    Self {
...
from!(item: &karlsen_rpc_core::GetCurrentBlockColorRequest, protowire::GetCurrentBlockColorRequestMessage, {
    Self {
        hash: item.hash.to_string()
    }
});
from!(item: RpcResult<&karlsen_rpc_core::GetCurrentBlockColorResponse>, protowire::GetCurrentBlockColorResponseMessage, {
...
from!(item: RpcResult<&karlsen_rpc_core::GetUtxoReturnAddressResponse>, protowire::GetUtxoReturnAddressResponseMessage, {
...
from!(item: RpcResult<&karlsen_rpc_core::GetMetricsResponse>, protowire::GetMetricsResponseMessage, {
    Self {
...
from!(item: &karlsen_rpc_core::GetConnectionsRequest, protowire::GetConnectionsRequestMessage, {
    Self {
        include_profile_data : item.include_profile_data,
    }
});
from!(item: RpcResult<&karlsen_rpc_core::GetConnectionsResponse>, protowire::GetConnectionsResponseMessage, {
    Self {
...
from!(&karlsen_rpc_core::GetSystemInfoRequest, protowire::GetSystemInfoRequestMessage);
from!(item: RpcResult<&karlsen_rpc_core::GetSystemInfoResponse>, protowire::GetSystemInfoResponseMessage, {
    Self {
...
from!(item: &karlsen_rpc_core::NotifyUtxosChangedRequest, protowire::NotifyUtxosChangedRequestMessage, {
...
from!(item: RejectReason, karlsen_rpc_core::SubmitBlockReport, {
    match item {
        RejectReason::None => karlsen_rpc_core::SubmitBlockReport::Success,
        RejectReason::BlockInvalid => karlsen_rpc_core::SubmitBlockReport::Reject(karlsen_rpc_core::SubmitBlockRejectReason::BlockInvalid),
        RejectReason::IsInIbd => karlsen_rpc_core::SubmitBlockReport::Reject(karlsen_rpc_core::SubmitBlockRejectReason::IsInIBD),
    }
});

try_from!(item: &protowire::SubmitBlockRequestMessage, karlsen_rpc_core::SubmitBlockRequest, {
    Self {
        block: item
            .block
            .as_ref()
...
impl TryFrom<&protowire::SubmitBlockResponseMessage> for karlsen_rpc_core::SubmitBlockResponse {
    type Error = RpcError;
    // This conversion breaks the general conversion convention (see file header) since the message may
...
try_from!(item: &protowire::GetBlockTemplateRequestMessage, karlsen_rpc_core::GetBlockTemplateRequest, {
    Self { pay_address: item.pay_address.clone().try_into()?, extra_data: RpcExtraData::from_iter(item.extra_data.bytes()) }
});
try_from!(item: &protowire::GetBlockTemplateResponseMessage, RpcResult<karlsen_rpc_core::GetBlockTemplateResponse>, {
    Self {
        block: item
            .block
            .as_ref()
...
try_from!(item: &protowire::GetBlockRequestMessage, karlsen_rpc_core::GetBlockRequest, {
    Self { hash: RpcHash::from_str(&item.hash)?, include_transactions: item.include_transactions }
});
try_from!(item: &protowire::GetBlockResponseMessage, RpcResult<karlsen_rpc_core::GetBlockResponse>, {
    Self {
        block: item
            .block
            .as_ref()
...
try_from!(item: &protowire::GetMempoolEntryRequestMessage, karlsen_rpc_core::GetMempoolEntryRequest, {
    Self {
        transaction_id: karlsen_rpc_core::RpcTransactionId::from_str(&item.tx_id)?,
        include_orphan_pool: item.include_orphan_pool,
        filter_transaction_pool: item.filter_transaction_pool,
    }
});
try_from!(item: &protowire::GetMempoolEntryResponseMessage, RpcResult<karlsen_rpc_core::GetMempoolEntryResponse>, {
    Self {
        mempool_entry: item
            .entry
            .as_ref()
...
try_from!(item: &protowire::GetMempoolEntriesRequestMessage, karlsen_rpc_core::GetMempoolEntriesRequest, {
    Self { include_orphan_pool: item.include_orphan_pool, filter_transaction_pool: item.filter_transaction_pool }
});
try_from!(item: &protowire::GetMempoolEntriesResponseMessage, RpcResult<karlsen_rpc_core::GetMempoolEntriesResponse>, {
...
try_from!(item: &protowire::GetSubnetworkRequestMessage, karlsen_rpc_core::GetSubnetworkRequest, {
    Self { subnetwork_id: karlsen_rpc_core::RpcSubnetworkId::from_str(&item.subnetwork_id)? }
});
try_from!(item: &protowire::GetSubnetworkResponseMessage, RpcResult<karlsen_rpc_core::GetSubnetworkResponse>, {
    Self { gas_limit: item.gas_limit }
});

try_from!(item: &protowire::GetVirtualChainFromBlockRequestMessage, karlsen_rpc_core::GetVirtualChainFromBlockRequest, {
...
try_from!(item: &protowire::GetVirtualChainFromBlockResponseMessage, RpcResult<karlsen_rpc_core::GetVirtualChainFromBlockResponse>, {
    Self {
...
try_from!(item: &protowire::GetBlocksRequestMessage, karlsen_rpc_core::GetBlocksRequest, {
    Self {
...
try_from!(item: &protowire::GetBlocksResponseMessage, RpcResult<karlsen_rpc_core::GetBlocksResponse>, {
    Self {
...
try_from!(item: &protowire::GetHeadersResponseMessage, RpcResult<karlsen_rpc_core::GetHeadersResponse>, {
    // TODO
    Self { headers: vec![] }
});

try_from!(item: &protowire::GetUtxosByAddressesRequestMessage, karlsen_rpc_core::GetUtxosByAddressesRequest, {
    Self { addresses: item.addresses.iter().map(|x| x.as_str().try_into()).collect::<Result<Vec<_>, _>>()? }
});
try_from!(item: &protowire::GetUtxosByAddressesResponseMessage, RpcResult<karlsen_rpc_core::GetUtxosByAddressesResponse>, {
    Self { entries: item.entries.iter().map(|x| x.try_into()).collect::<Result<Vec<_>, _>>()? }
});

try_from!(item: &protowire::GetBalanceByAddressRequestMessage, karlsen_rpc_core::GetBalanceByAddressRequest, {
    Self { address: item.address.as_str().try_into()? }
});
try_from!(item: &protowire::GetBalanceByAddressResponseMessage, RpcResult<karlsen_rpc_core::GetBalanceByAddressResponse>, {
    Self { balance: item.balance }
});

try_from!(item: &protowire::GetBalancesByAddressesRequestMessage, karlsen_rpc_core::GetBalancesByAddressesRequest, {
    Self { addresses: item.addresses.iter().map(|x| x.as_str().try_into()).collect::<Result<Vec<_>, _>>()? }
});
try_from!(item: &protowire::GetBalancesByAddressesResponseMessage, RpcResult<karlsen_rpc_core::GetBalancesByAddressesResponse>, {
    Self { entries: item.entries.iter().map(|x| x.try_into()).collect::<Result<Vec<_>, _>>()? }
});
...
try_from!(
    ...
    RpcResult<karlsen_rpc_core::EstimateNetworkHashesPerSecondResponse>,
    { Self { network_hashes_per_second: item.network_hashes_per_second } }
);

try_from!(item: &protowire::GetMempoolEntriesByAddressesRequestMessage, karlsen_rpc_core::GetMempoolEntriesByAddressesRequest, {
    Self {
...
try_from!(
    ...
    RpcResult<karlsen_rpc_core::GetMempoolEntriesByAddressesResponse>,
    { Self { entries: item.entries.iter().map(|x| x.try_into()).collect::<Result<Vec<_>, _>>()? } }
);
...
try_from!(item: &protowire::GetDaaScoreTimestampEstimateRequestMessage, karlsen_rpc_core::GetDaaScoreTimestampEstimateRequest , {
    Self {
        daa_scores: item.daa_scores.clone()
    }
});
try_from!(item: &protowire::GetDaaScoreTimestampEstimateResponseMessage, RpcResult<karlsen_rpc_core::GetDaaScoreTimestampEstimateResponse>, {
    Self { timestamps: item.timestamps.clone() }
});

try_from!(&protowire::GetFeeEstimateRequestMessage, karlsen_rpc_core::GetFeeEstimateRequest);
try_from!(item: &protowire::GetFeeEstimateResponseMessage, RpcResult<karlsen_rpc_core::GetFeeEstimateResponse>, {
    Self {
...
try_from!(item: &protowire::GetFeeEstimateExperimentalRequestMessage, karlsen_rpc_core::GetFeeEstimateExperimentalRequest, {
    Self {
        verbose: item.verbose
    }
});
try_from!(item: &protowire::GetFeeEstimateExperimentalResponseMessage, RpcResult<karlsen_rpc_core::GetFeeEstimateExperimentalResponse>, {
    Self {
        estimate: item.estimate
            .as_ref()
...
try_from!(item: &protowire::GetCurrentBlockColorRequestMessage, karlsen_rpc_core::GetCurrentBlockColorRequest, {
    Self {
...
try_from!(item: &protowire::GetUtxoReturnAddressResponseMessage, RpcResult<karlsen_rpc_core::GetUtxoReturnAddressResponse>, {
...
try_from!(item: &protowire::GetMetricsResponseMessage, RpcResult<karlsen_rpc_core::GetMetricsResponse>, {
    Self {
        server_time: item.server_time,
...
try_from!(item: &protowire::GetConnectionsRequestMessage, karlsen_rpc_core::GetConnectionsRequest, {
    Self { include_profile_data : item.include_profile_data }
});
try_from!(item: &protowire::GetConnectionsResponseMessage, RpcResult<karlsen_rpc_core::GetConnectionsResponse>, {
    Self {
        clients: item.clients,
...
try_from!(&protowire::GetSystemInfoRequestMessage, karlsen_rpc_core::GetSystemInfoRequest);
try_from!(item: &protowire::GetSystemInfoResponseMessage, RpcResult<karlsen_rpc_core::GetSystemInfoResponse>, {
    Self {
        version: item.version.clone(),
...
try_from!(item: &protowire::NotifyUtxosChangedRequestMessage, karlsen_rpc_core::NotifyUtxosChangedRequest, {
    Self {
        addresses: item.addresses.iter().map(|x| x.as_str().try_into()).collect::<Result<Vec<_>, _>>()?,
        command: item.command.into(),
    }
});
try_from!(item: &protowire::StopNotifyingUtxosChangedRequestMessage, karlsen_rpc_core::NotifyUtxosChangedRequest, {
    Self {
        addresses: item.addresses.iter().map(|x| x.as_str().try_into()).collect::<Result<Vec<_>, _>>()?,
