...
mod mockery {
    ...
    use karlsen_consensus_core::api::BlockCount;
    ...
    use karlsen_rpc_macros::test_wrpc_serializer as test;
    use karlsen_utils::networking::{ContextualNetAddress, IpAddress, NetAddress};
    use rand::Rng;
