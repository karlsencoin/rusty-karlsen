...
///
///
/// Karlsen RPC client uses ([wRPC](https://github.com/workflow-rs/workflow-rs/tree/master/rpc))
/// interface to connect directly with Karlsen Node. wRPC supports
/// two types of encodings: `borsh` (binary, default) and `json`.
///
/// There are two ways to connect: Directly to any Karlsen Node or to a
...
/// ```
///
/// **Connecting to a Karlsen Node directly**
///
/// ```javascript
/// let rpc = new RpcClient({
...
/// to re-register event listeners, but your have to re-subscribe for Karlsen node
/// notifications:
///
/// ```typescript
/// rpc.addEventListener("connect", async (event) => {
...
impl RpcClient {
    ...
    /// Disconnect from the Karlsen RPC server.
    ...
    /// however, you have to re-subscribe for Karlsen node notifications. As such, it is recommended
...
impl RpcClient {
    pub fn new_with_rpc_client(client: Arc<KarlsenRpcClient>) -> RpcClient {
...
impl RpcClient {
    ...
    pub fn parse_url(url: &str, encoding: Encoding, network: NetworkId) -> Result<String> {
        let url_ = KarlsenRpcClient::parse_url(url.to_string(), encoding, network.into())?;
        Ok(url_)
    }
}
...
impl RpcClient {
    ...
    /// Karlsen BlockDAG. The event notification will be scoped to the
...
build_wrpc_wasm_bindgen_interface!(
    [
        ...
        /// Retrieves the current number of blocks in the Karlsen BlockDAG.
        ...
        /// structure of the Karlsen BlockDAG.
        ...
        GetBlockDagInfo,
        /// Returns the total current coin supply of Karlsen network.
        /// Returned information: Total coin supply.
        GetCoinSupply,
        /// Retrieves information about the peers connected to the Karlsen node.
        /// Returned information: Peer ID, IP address and port, connection
        /// status, protocol version.
        GetConnectedPeerInfo,
        /// Retrieves general information about the Karlsen node.
        /// Returned information: Version of the Karlsen node, protocol
        /// version, network identifier.
        /// This call is primarily used by gRPC clients.
        /// For wRPC clients, use {@link RpcClient.getServerInfo}.
        GetInfo,
        /// Provides a list of addresses of known peers in the Karlsen
        ...
        /// performance and status of the Karlsen node.
        ...
        /// the highest cumulative difficulty in the Karlsen BlockDAG.
        ...
        GetSinkBlueScore,
        /// Tests the connection and responsiveness of a Karlsen node.
        /// Returned information: None.
        Ping,
        /// Gracefully shuts down the Karlsen node.
        /// Returned information: None.
        Shutdown,
        /// Retrieves information about the Karlsen server.
        /// Returned information: Version of the Karlsen server, protocol
        /// version, network identifier.
        GetServerInfo,
        /// Obtains basic information about the synchronization status of the Karlsen node.
    ...
    [
        ...
        /// Adds a peer to the Karlsen node's list of known peers.
        /// Returned information: None.
        AddPeer,
        /// Bans a peer from connecting to the Karlsen node for a specified duration.
        /// Returned information: None.
        Ban,
        ...
        /// Retrieves the balance of a specific address in the Karlsen BlockDAG.
        /// Returned information: Balance of the address.
        GetBalanceByAddress,
        /// Retrieves balances for multiple addresses in the Karlsen BlockDAG.
        /// Returned information: Balances of the addresses.
        GetBalancesByAddresses,
        /// Retrieves a specific block from the Karlsen BlockDAG.
        /// Returned information: Block information.
        GetBlock,
        /// Retrieves multiple blocks from the Karlsen BlockDAG.
        ...
        /// Retrieves block headers from the Karlsen BlockDAG.
        /// Returned information: List of block headers.
        GetHeaders,
        /// Retrieves mempool entries from the Karlsen node's mempool.
        ...
        GetMempoolEntry,
        /// Retrieves information about a subnetwork in the Karlsen BlockDAG.
        ...
        /// Resolves a finality conflict in the Karlsen BlockDAG.
        /// Returned information: None.
        ResolveFinalityConflict,
        /// Submits a block to the Karlsen network.
        /// Returned information: None.
        SubmitBlock,
        /// Submits a transaction to the Karlsen network.
        /// Returned information: Submitted Transaction Id.
        SubmitTransaction,
        /// Submits an RBF transaction to the Karlsen network.
