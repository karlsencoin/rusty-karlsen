# Contributing to Karlsen

Thanks for your interest in contributing to Karlsen!
...
The primary venue for discussion is GitHub. Open an [Issue](https://github.com/karlsen-network/rusty-karlsen/issues) for design or specification questions, or jump straight to a Pull Request when you have code to share.

For broader ecosystem topics see [karlsencoin.org](https://karlsencoin.org/).
...
- Write detailed pull request descriptions: explain what you changed, why, design decisions, and any trade-offs.
...
2. Fork the repo (see the [Installation](https://github.com/karlsen-network/rusty-karlsen?tab=readme-ov-file#installation) guide) and create a feature branch with a short, descriptive name.
...
- Run `cargo nextest run --release` and make sure all tests still pass.
...
Thanks for helping make Karlsen better.
